        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <form action="{{ route('auth.register.store') }}" method="post">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="privacy"><a href="javascript: void(0);" class="text-dark">شرابط و قوانین</a> را می پذیرم</label>
                            </div>
                        </div>
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    <p class="text-muted">حساب کاربری دارید؟  <a href="{{ route('auth.login') }}" class="text-dark ml-1"><b>وارد شوید</b></a></p>
                </div>
            </div>
