        ...
        <div class="container" style="transform: none;">
            <div class="entry-header entry-header-1 mb-30 mt-50">
                <div class="entry-meta meta-0 font-small mb-30">
                    <a href=""><span class="post-cat bg-success color-white">{{ $article->category->title }}</span>
                    </a>
                </div>
                ...
                <div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
                    ...
                    <span class="time-reading">زمان خواندن{{$article->time_to_read}} 12 دقیقه</span>
                    <p class="font-x-small mt-10">
                        ...
                        <span class="hit-count"><i class="ti-star ml-5"></i>امتیاز{{ $article->score }} 8/10</span>
                    </p>
                </div>
            </div>
            <!--end entry header-->
            ...
            <div class="row">
                <div class="col-12 text-center mb-50">
                    <a href="#">
                        <img class="border-radius-10 d-inline" src="{{asset('assets/imgs/ads-3.png')}}" alt="">
                    </a>
                </div>
            </div>
        </div>
