                                ...
                                <div class="loop-grid">
                                    <div class="row">
                                      ...
                                      @foreach($articles as $article)
                                            <article class="col-lg-6 col-md-12 wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
                                                <div class="background-white border-radius-10 p-10 mb-30">
                                                    <div class="post-thumb d-flex mb-15 border-radius-15 img-hover-scale">
                                                        <a href="{{$article->path()}}">
                                                            <img class="border-radius-15 style-article-img"
                                                                 src="{{ $article->imagePath }}" alt="image article">
                                                        </a>
                                                    </div>
                                                    <div class="pl-10 pr-10">
                                                        ...
                                                        <h5 class="post-title mb-15">
                                                            <a href="{{$article->path()}}">{{ $article->title }}</a></h5>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="post-content media-body">
                                                        ...
                                                        <div class="entry-meta meta-1 font-x-small color-grey float-right text-uppercase">
                                                            <span class="post-by">توسط
                                                                <a href="{{$article->user->path()}}">{{ $article->user->name }}
                                                                </a>
                                                            </span>
                                                            <span class="post-on">
                                    ...
                                    @foreach($latestComments as $comment)
                                        <div class="last-comment mb-20 d-flex wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                                            <span class="item-count vertical-align">
                                                <a class="red-tooltip author-avatar" href="{{ $comment->user->path() }}" data-toggle="tooltip"
                                                   data-placement="top"
                                            ...
                                            <div class="alith_post_title_small">
                                                <p class="font-medium mb-10">
                                                    <a href="{{ $comment->commentable->path() }}">{{Illuminate\Support\Str::limit($comment->body)}}
                                                    </a>
                                                </p>
                                                <div class="entry-meta meta-1 font-x-small color-grey float-right text-uppercase mb-10">
                                                    <span class="post-by">توسط <a href="{{ $comment->user->path() }}">{{ $comment->user->name }}</a></span>
