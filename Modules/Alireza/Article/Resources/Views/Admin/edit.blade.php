...
@section('title', 'ویرایش مقاله جدید' . $article->title)
...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title">ویرایش مقاله جدید {{ $article->title }}</h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('articles.update', $article->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('keywords') is-invalid @enderror"
                                                   ...
                                                   placeholder="کلمات دسته بندی را وارد کنید">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2  col-form-label" for="time_to_read">زمان مطالعه</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('time_to_read') is-invalid @enderror"
                                                   ...
                                                   placeholder="زمان برای مطالعه مقاله را وارد کنید">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('status') is-invalid @enderror" name="status">
                                                @foreach (Alireza\Article\Models\Article::$statuses as $status)
                                                    <option @if($article->$status === $status) selected @endif
                                                        value="{{ $status }}">@lang($status)</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('status') is-invalid @enderror" name="type">
                                                @foreach (Alireza\Article\Models\Article::$types as $type)
                                                    <option @if($article->$type === $type) selected @endif
                                                        value="{{ $type }}">@lang($type)</option>
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('category_id') is-invalid @enderror"name="category_id">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option @if($article->caregory_id === $category->id) selected @endif
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2  col-form-label" for="image">تصویر</label>
                                        <div class="col-sm-10">
