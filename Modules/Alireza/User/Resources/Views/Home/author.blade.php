                ...
                <div class="col-lg-8 col-md-12">
                    <div class="author-bio border-radius-10 bg-white p-30 mb-50">
                        <div class="author-image mb-30">
                            <a href="#"><img src="{{ $author->image() }}" alt="author image" class="avatar"></a></div>
                        <div class="author-info">
                            ...
                            <a href="author.html" class="author-bio-link text-muted"><span class="ml-5 font-x-small"><ion-icon name="person-add" role="img" class="md hydrated" aria-label="person add"></ion-icon></span>این نویسنده را دنبال کنید</a>
                            <div class="author-social">
                                <ul class="author-social-icons">
                                    <li class="author-social-link-facebook">
                                        <a href="{{ $author->telegram }}" target="_blank">
                                           <img src="{{asset('home/imgs/telegram.pnp')}}" alt="telegram">
                                        </a>
                                    </li>
                                    <li class="author-social-link-twitter">
                                        <a href="{{ $author->twitter }}" target="_blank"><i class="ti-twitter-alt"></i></a></li>
                                    <li class="author-social-link-pinterest">
                                        <a href="{{ $author->linkedin }}" target="_blank"><i class="ti-linkedin"></i></a></li>
                                    <li class="author-social-link-instagram">
                                        <a href="{{ $author->instagram }}" target="_blank"><i class="ti-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
