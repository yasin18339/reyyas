            ...
            <div class="row mb-50">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="entry-main-content mt-50">
                        ...
                        <h1 class="mt-30">بروز رسانی پروفایل کاربری</h1>
                        <hr class="wp-block-separator is-style-wide">
                        ...
                        enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control @error('telegram') is-invalid @enderror" name="telegram"
                                               id="telegram" type="text" placeholder="تلگرام" value="{{ auth()->user()->telegram }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control @error('linkedin') is-invalid @enderror" name="linkedin"
                                               id="linkedin" type="text" placeholder="لینکدین" value="{{ auth()->user()->linkedin }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control @error('twitter') is-invalid @enderror" name="twitter"
                                               id="twitter" type="text" placeholder="توییتر" value="{{ auth()->user()->twitter}}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control @error('instagram') is-invalid @enderror" name="instagram"
                                               id="instagram" type="text" placeholder="اینستاگرام" value="{{ auth()->user()->instagram }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100 @error('bio') is-invalid @enderror"
                                                  name="bio" id="bio" cols="30" rows="9" placeholder="بیوگرافی">
                                            {{ auth()->user()->bio}}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="button button-contactForm">ذخیره اطلاعات</button>
                            </div>
                        </form>
                    </div>
                </div>
