...
namespace Alireza\Panel\Providers;

use Alireza\Panel\Models\Panel;
use Alireza\Panel\Policies\PanelPolicy;
...
class PanelServiceProvider extends ServiceProvider
{
    public function register()
    {
        ...
        Route::middleware('web')->namespace('Alireza\Panel\Http\Controllers')->group(__DIR__ . '/../Routes/panel_routes.php');
