        ...
        <div class="row">
                ...
                <div class="card-box widget-user">
                    <div>
                        <div class="avatar-lg float-left mr-3">
                            <img src="{{ asset('admin/images/users/user-3.jpg') }}" class="img-fluid rounded-circle" alt="کاربر">
                        </div>
                        <div class="wid-u-info">
                            <h5 class="mt-0">علیرضا دادگرحسینی</h5>
                            <p class="text-muted mb-1 font-13 text-truncate">a.dadgar2021@gmail.com</p>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <div class="avatar-lg float-left mr-3">
                            <img src="{{ asset('admin/images/users/user-2.jpg') }}" class="img-fluid rounded-circle" alt="کاربر">
                        </div>
                        <div class="wid-u-info">
                            <h5 class="mt-0"> </h5>
                            <p class="text-muted mb-1 font-13 text-truncate">a.dadgar2021@gmail.com</p>
